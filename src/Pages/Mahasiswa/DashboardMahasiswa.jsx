...
export default function DashboardMahasiswa() {
  ...
  // Antisipasi jika user tidak ada / data tidak lengkap
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-gray-600 mb-6">Anda sedang berada di dashboard mahasiswa.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <div className="bg-blue-600 text-white p-5 rounded-xl shadow cursor-pointer hover:bg-blue-700 transition">
        ...
        <div className="bg-green-600 text-white p-5 rounded-xl shadow cursor-pointer hover:bg-green-700 transition">
        ...
        <div className="bg-yellow-500 text-white p-5 rounded-xl shadow cursor-pointer hover:bg-yellow-600 transition">
        ...
        <div className="bg-red-500 text-white p-5 rounded-xl shadow cursor-pointer hover:bg-red-600 transition">
